...
The big change here is the much lower \texttt{net\_worth}. Maximums are very
sensitive because they reflect only the most extreme data points. As a result, a
lot of randomness must be added to protect them. In this case, the $b$ value for
maximum \texttt{net\_worth} is over 1.3 million, resulting in a 25\% error. The
income and age end up being quite accurate, but only because the lower net worth
caused us to match 2 different indivudals, both of whom happened to be old and
rich. The ritchest person's privacy is still very safe.
