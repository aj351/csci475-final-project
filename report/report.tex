...
today. However everything from simply removing columns containing personally
...
For the case that zero rows are returned, we add a fake entry whose value is the
...
\begin{itemize}
    ...
    \item Our implementation is not heavily optimized. Currently, some queries
        ...
        our implementation, we could improve the performance of our system using
